class intro extends Phaser.Scene{
    ...
    create(){
        this.add.bitmapText(centerX, centerY - 200, 'dis_letter_blue', 'HOW TO PLAY', 70).setOrigin(0.5)
        this.add.bitmapText(centerX, centerY, 'dis_letter_blue',
        ...
        let flashText = this.add.bitmapText(centerX, centerY + 300, 'dis_letter_blue', "Press [SPACE] to start", 50).setOrigin(0.5);
        this.tweens.add({
            targets: flashText, 
            alpha: { from: 1, to: 0 },
            duration: 2000, 
